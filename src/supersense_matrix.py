...
./supersense_matrix.py --word_counter_threshold 5 --out_file ../data/supersenses/semcor_noun_verb.supersenses.filtered
...
parser.add_argument("--out_file", default="../data/supersense_semcor.txt")
